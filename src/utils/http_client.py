...
class HttpClient:
    ...
    def __print_response_hook__(self, request: requests.Response, *args, **kwargs) -> None:
        self.logger.info(f" {request.status_code} on {request.request.method} {request.url}")
